...
<body>
        ...
        <div class="container__child signup__thumbnail">
            ...
            <h2 class="heading--secondary">Join in as a vendor!</h2>
            <br>
            </div>
            <div class="signup__overlay"></div>
        </div>
        <div class="container__child signup__form center txtlft">
            <form action="vendorreg_index.php" method="post">
            <div class="form-group">
                <label for="username">Name</label>
                <input class="form-control" type="text" name="vendor_name" id="username" required />
            </div>
            <br>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="vendor_phone_number" id="phone" required />
            </div>
            <br>
            <div class="form-group">
            ...
            <div class="m-t-lg">
                ...
                <br>
                <li>
                    <a class="signup__link" href="vender_login.php">I am already a member</a>
                </li>
                </ul>
            </div>
            </form>  
