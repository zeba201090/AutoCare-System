        ...
        <div id="header-carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <img class="w-100" src="img/car6.jpg" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3"></h4>
                            <h1 class="display-3 text-white mb-md-4">Highly Professional And Verifed Staffs</h1>
                             <a href="vendor_registration.php" class="btn btn-primary py-md-3 px-md-5 mt-2">SIGN UP TODAY</a>
                            <a href="vendor_login.php" class="btn btn-primary py-md-3 px-md-5 mt-2">SIGN IN</a>                       
                             </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <img class="w-100" src="img/car7.png" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">

                            <h6 class="display-3 text-white ">                     </h6>
<br>
<br>
<br>
<br>
<br>
                            ...
                            <a href="home.php" class="btn btn-primary py-md-3 px-md-5 mt-2">


 SIGN UP TODAY</a>
                            <a href="owner_login.php" class="btn btn-primary py-md-3 px-md-5 mt-2">
    ...
    <!-- <div class="container-fluid contact-info mt-5 mb-4">
        <div class="container" style="padding: 0 30px;">
            <div class="row">
                <div class="col-md-4 d-flex align-items-center justify-content-center bg-secondary mb-4 mb-lg-0" style="height: 70px;">
                ...
                <div class="col-md-4 d-flex align-items-center justify-content-center bg-primary mb-4 mb-lg-0" style="height: 70px;">
    ...
    <div class="container-fluid py-5">
        <div class="container pt-0 pt-lg-4">
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <img class="img-fluid" src="img/carfront.jpg" alt="">
                </div>
                <div class="col-lg-7 mt-5 mt-lg-0 pl-lg-5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 pt-3">
                            <div class="d-flex align-items-center">
                                <i class="fa fa-check text-primary mr-2"></i>
                                <p class="text-secondary font-weight-medium m-0">Instant Repair Appointments</p>
                        </div>
                        </div>
                        ...
                        <div class="col-sm-6 pt-3">
                            <div class="d-flex align-items-center">
                                <i class="fa fa-check text-primary mr-2"></i>
                                <p class="text-secondary font-weight-medium m-0">All Repair Service</p>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 pt-3">
                            <div class="d-flex align-items-center">
                                <i class="fa fa-check text-primary mr-2"></i>
                                <p class="text-secondary font-weight-medium m-0">All Services in one platform</p>
                            </div>
                        </div>
                        <div class="col-sm-6 pt-3">
                            <div class="d-flex align-items-center">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 pb-1">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center bg-light mb-4 px-4" style="height: 300px;">
                        <div class="d-inline-flex align-items-center justify-content-center bg-white shadow rounded-circle mb-4" style="width: 100px; height: 100px;">
                            <i class="fa fa-3x fa-check text-secondary"></i>
                        </div>
                        <h4 class="font-weight-bold m-0">Premium Car Wash</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 pb-1">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center bg-light mb-4 px-4" style="height: 300px;">
                ...
                <div class="col-lg-3 col-md-6 pb-1">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center bg-light mb-4 px-4" style="height: 300px;">
                        ...
                        <h4 class="font-weight-bold m-0"> Marketplace of Spare Parts</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 pb-1">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center bg-light mb-4 px-4" style="height: 300px;">
                        ...
                        <h4 class="font-weight-bold m-0">Home Services </h4>
                    </div>
                </div>
                        <a href="service.html" class="nav-item nav-link">Learn More About Services →</a>
            </div>
        </div>
    </div>
    <!-- Services End -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 m-0 my-lg-5 pt-0 pt-lg-5 pr-lg-5">
                    ...
                    <p>Our motive is to provide convenience and reliance to the valuable vehicle owners. We know that honesty and transparency, coupled with reliable and friendly customer service, is what really builds customer trust.</p>
                    <div class="row">
                        
                        <div class="col-sm-6 mb-4">
                            <h1 class="text-secondary" > 50+ </h1>
                            <h5 class="font-weight-bold">Vehicle Services</h5>
                        </div>
                        <div class="col-sm-6 mb-4">
                            <h1 class="text-secondary" > 100+ </h1>
                            <h5 class="font-weight-bold">Verified Merchants</h5>
                        </div>
                        <div class="col-sm-6 mb-4">
                            <h1 class="text-secondary" > 10000+ </h1>
                            <h5 class="font-weight-bold">Vehicle Parts And Accessories </h5>
                        </div>
                        <div class="col-sm-6 mb-4">
                            <h1 class="text-secondary" >6000+ </h1>
                            <h5 class="font-weight-bold">On Platform Vehicles </h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5">
                    <div class="d-flex flex-column align-items-center justify-content-center bg-secondary h-100 py-5 px-3">
                        ...
                        <h1 class="display-1 text-white mb-3">5K+</h1>
                        <h1 class="text-white m-0"> Happy Clients </h1>
                    </div>
                </div>
            </div>
        </div>
